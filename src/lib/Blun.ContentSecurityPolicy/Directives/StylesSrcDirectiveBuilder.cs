...
namespace Blun.ContentSecurityPolicy.Directives
{
    public sealed class StylesSrcDirectiveBuilder :
        ...
        INone<StylesSrcDirectiveBuilder>,
        ...
        IAllowHash<StylesSrcDirectiveBuilder>
    {
        ...
        public new StylesSrcDirectiveBuilder Allow(Uri source) => (StylesSrcDirectiveBuilder)base.Allow(source);
        public new StylesSrcDirectiveBuilder None() => (StylesSrcDirectiveBuilder)base.AllowNone();
