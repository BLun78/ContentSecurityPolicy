...
namespace Blun.ContentSecurityPolicy.Directives
{
    public sealed class DefaultSrcDirectiveBuilder :
        ...
        INone<DefaultSrcDirectiveBuilder>,
        ...
        IAllowReportSample<DefaultSrcDirectiveBuilder>
    {
        ...
        public new DefaultSrcDirectiveBuilder Allow(Uri source) => (DefaultSrcDirectiveBuilder)base.Allow(source);
        public new DefaultSrcDirectiveBuilder None() => (DefaultSrcDirectiveBuilder)base.AllowNone();
