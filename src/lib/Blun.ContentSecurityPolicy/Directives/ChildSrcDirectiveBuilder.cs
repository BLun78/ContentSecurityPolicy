...
namespace Blun.ContentSecurityPolicy.Directives
{
    public sealed class ChildSrcDirectiveBuilder :
        ...
        INone<ChildSrcDirectiveBuilder>,
        ...
        IAllowReportSample<ChildSrcDirectiveBuilder>
    {
        ...
        public new ChildSrcDirectiveBuilder Allow(Uri source) => (ChildSrcDirectiveBuilder)base.Allow(source);
        public new ChildSrcDirectiveBuilder None() => (ChildSrcDirectiveBuilder)base.AllowNone();
